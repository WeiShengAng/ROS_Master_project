...
while True:
    ...
    pub1 = rospy.Publisher('Mod1_yoloseed', Int16, queue_size=16) # call arduino roll the seed
    pub1_command = seed
    pub1.publish(pub1_command)

    pub2 = rospy.Publisher('Mod1_yoloseedpoint', Int16, queue_size=16) # call arduino roll the seed
